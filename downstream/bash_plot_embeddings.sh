...
python visualize_embeddings.py --data_mvo /home/nadja/ECG_JEPA_Git/downstream/IBK_data/fold_IMH_4 --ckpt_dir /home/nadja/ECG_JEPA_Git/downstream/weights_mimic/epoch30.pth --dataset mvo --data_dir /gpfs/data/fs72515/nadja_g/ECG_JEPA/physionet/files/ptb-xl/1.0.3/ --pathology mvo --task multilabel
